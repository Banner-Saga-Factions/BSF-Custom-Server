...
| Retire double-refund race | #144 | POSTPONED | postponed 2026-07-19 — #154 zeroes the retire refund, which **fully** removes the double payment. **Fold into #164 (2026-07-30)**: the remaining substance is the retry loop. Mechanism and reasoning: [`../docs/client-contract.md`](../docs/client-contract.md) → R10 + R19. | S |
