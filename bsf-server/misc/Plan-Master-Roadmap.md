...
| Compare the two players' per-turn checksums (audit R15) | #165 | SEC | READY — we already store both in `Battle.ts:406-409` and never compare; the client's docs claim we do | S |
