# Changelog — history up to the 19 June 2026 update

## Co-Authored-By: Claude <noreply@anthropic.com>

This is the older half of the server's changelog: every release from the first one in April 2026 up
to and including the update announced on 19 June 2026. It was split out of
[`../../CHANGELOG.md`](../../CHANGELOG.md) when that file reached 228 KB. Nothing here was reworded
on the way across — the entries are exactly as they were written.

For anything newer, and for work that has not been announced to players yet, read
...
Announced to players in [Server patch update #142](https://github.com/Banner-Saga-Factions/BSF-Custom-Server/discussions/142).
...
Announced to players in [Community Update #106](https://github.com/Banner-Saga-Factions/BSF-Custom-Server/discussions/106).
...
Announced to players in [Community Update #65](https://github.com/Banner-Saga-Factions/BSF-Custom-Server/discussions/65).
