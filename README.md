...
See [bsf-server/CONTRIBUTING.md § Reference Codebases](bsf-server/CONTRIBUTING.md#10-reference-codebases-optional) for the ~10-minute setup, and [REFERENCE.md § Which mirror to use](REFERENCE.md#which-mirror-to-use) for what each directory is for and the "prefer 2013 source over decompile, 12 stale exceptions" rule.
